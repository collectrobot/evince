...
#include "/workspaces/evince/builddir/../libview/ev-document-model.h"
GType
...
#include "/workspaces/evince/builddir/../libview/ev-job-scheduler.h"
GType
...
#include "/workspaces/evince/builddir/../libview/ev-jobs.h"
GType
...
ev_job_page_data_flags_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id)) {
    static const GFlagsValue values[] = {
      ...
      { EV_PAGE_DATA_INCLUDE_MEDIA, "EV_PAGE_DATA_INCLUDE_MEDIA", "media" },
